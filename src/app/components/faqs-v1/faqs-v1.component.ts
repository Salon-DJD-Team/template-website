...
@Component({
  selector: 'app-faqs-v1',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './faqs-v1.component.html',
})
export class FaqsV1Component implements OnInit {
  ...
  ngOnInit() {
    ...
    this.leftFaqs = this.faqs.slice(0, half);
    this.rightFaqs = this.faqs.slice(half);
  }
